...
function FormContainer() {
  return (
    <div className="bg-white p-5 rounded-xl">
      ...
      <div className="mt-5">
        <h2 className="text-sm font-medium">Job Postion</h2>
        <Textarea placeholder="Enter the description of Job Postion" className="mt-2 h-[150px]" />
      </div>
      <div className="mt-5">
      ...
      <div className="mt-5">
        ...
        <div className="flex gap-3 flex-wrap mt-2">
          {InterviewType.map((type, index) => (
            <div key={index} className="hover:bg-secondary flex gap-2 items-center cursor-pointer p-1 px-2 bg-white border border-gray-300 rounded-2xl">
      ...
      <div className="mt-7 flex justify-end"><Button>
        <ArrowRight />Generate Questions
      </Button></div>
    </div>
  )
}
