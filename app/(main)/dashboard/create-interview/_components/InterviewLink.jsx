...
import { ArrowLeft, Calendar, Clock, Copy, List, Mail, MessageCircle, Plus, SlackIcon } from "lucide-react";
    ...
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <div className="w-full bg-white p-7 rounded-xl mt-5">
        <div className="flex justify-between items-center">
          ...
          <h2 className="p-1 px-2 text-primary bg-blue-50 rounded">Valid for 1 day</h2>
        </div>
      ...
      <div className="mt-7 bg-white p-5 rounded-lg w-full">
        ...
        <div className="flex gap-7">
          ...
          <Button variant={'outline'}><SlackIcon />Slack </Button>
